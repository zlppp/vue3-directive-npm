...
var Tree = (0, _vue.defineComponent)({
  ...
  data: function data() {
    ...
    return _extends(_extends({}, state), this.getDerivedState((0, _propsUtil.getOptionProps)(this), state));
  },
  ...
  render: function render() {
    ...
    var domProps = (0, _util.getDataAndAria)(_extends(_extends({}, this.$props), this.$attrs));
    var _this$$attrs = this.$attrs,
        className = _this$$attrs.class,
        style = _this$$attrs.style;
    return (0, _vue.createVNode)("ul", _objectSpread(_objectSpread({}, domProps), {}, {
